...
impl DataManager {
    ...
    pub fn get_all_charms(&self) -> Vec<structs::CharmData> {
    ...
    pub fn get_box_metadata(&self, box_location: usize) -> structs::EquipBoxMetadata {
        let meta_ptr: usize =
    ...
    pub fn get_charm_at(&self, charm_location: usize) -> Option<structs::CharmData> {
        let equip_type: u32 =
